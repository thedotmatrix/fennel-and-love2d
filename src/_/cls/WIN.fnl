...
(fn WIN.new [! parent name w h]
  ...
  (set !.mat (MAT parent.mat 1 (parent.mat:border false)
             (- w 2) (- h (* 2 (parent.mat:border true)))))
...
(fn WIN.draw [!]
  ...
  (let [(x y)   (values 1 (!.mat.parent:border))
    ...
    (love.graphics.rectangle :line (* -1 x) (* -1 y) ow oh)
    ...
    (love.graphics.setColor 0 0 0)
    (love.graphics.rectangle :line 0 0 iw ih)
