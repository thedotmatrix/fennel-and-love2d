...
package.preload["fennel.repl"] = package.preload["fennel.repl"] or function(...)
  ...
  local function default_on_error(errtype, err)
    local function _655_()
      local _654_0 = errtype
      if (_654_0 == "Runtime") then
  ...
  local function splice_save_locals(env, lua_source, scope)
    ...
    local function _664_()
      local _662_0, _663_0 = lua_source:match("^(.*)[\n ](return .*)$")
      if ((nil ~= _662_0) and (nil ~= _663_0)) then
        local body = _662_0
        local _return = _663_0
  ...
  local function completer(env, scope, text, _3ffulltext, _from, _to)
    ...
    local function add_partials(input, tbl, prefix)
      ...
      for k, is_mangled in utils.allpairs(_666_()) do
    ...
    do
      local _675_0 = tostring((_3ffulltext or text)):match("^%s*,([^%s()[%]]*)$")
      if (nil ~= _675_0) then
        local cmd_fragment = _675_0
  ...
  local function reload(module_name, env, on_values, on_error)
    local _679_0, _680_0 = pcall(specials["load-code"]("return require(...)", env), module_name)
    if ((_679_0 == true) and (nil ~= _680_0)) then
      ...
      local new = nil
      do
        local _681_0, _682_0 = pcall(require, module_name)
        if ((_681_0 == true) and (nil ~= _682_0)) then
          local new0 = _682_0
          new = new0
        elseif (true and (nil ~= _682_0)) then
          local _0 = _681_0
          local msg = _682_0
          on_error("Repl", msg)
          new = old
      ...
      return on_values({"ok"})
    elseif ((_679_0 == false) and (nil ~= _680_0)) then
      local msg = _680_0
      ...
      elseif specials["macro-loaded"][module_name] then
        ...
        local function _687_()
          local _686_0 = msg:gsub("\n.*", "")
          return _686_0
        end
        return on_error("Runtime", _687_())
      end
    end
  end
  local function run_command(read, on_error, f)
    local _690_0, _691_0, _692_0 = pcall(read)
    if ((_690_0 == true) and (_691_0 == true) and (nil ~= _692_0)) then
      local val = _692_0
      local _693_0, _694_0 = pcall(f, val)
      if ((_693_0 == false) and (nil ~= _694_0)) then
        local msg = _694_0
        return on_error("Runtime", msg)
      end
    elseif (_690_0 == false) then
  ...
  local function apropos_2a(pattern, tbl, prefix, seen, names)
    for name, subtbl in pairs(tbl) do
      if (("string" == type(name)) and (package ~= subtbl)) then
        local _699_0 = type(subtbl)
        if (_699_0 == "function") then
          if ((prefix .. name)):match(pattern) then
            table.insert(names, (prefix .. name))
          end
        elseif (_699_0 == "table") then
          if not seen[subtbl] then
            ...
            apropos_2a(pattern, subtbl, (prefix .. name:gsub("%.", "/") .. "."), _701_, names)
          end
        end
      end
    end
    ...
    for _, path in ipairs(apropos(".*")) do
      ...
      do
        ...
        if ("function" == type(tgt)) then
          local _710_0 = (compiler.metadata):get(tgt, "fnl/docstring")
          if (nil ~= _710_0) then
            local docstr = _710_0
  ...
  commands["apropos-doc"] = function(_env, read, on_values, on_error, _scope)
    ...
    return run_command(read, on_error, _714_)
  end
  ...
  commands["apropos-show-docs"] = function(_env, read, on_values, on_error)
    ...
    return run_command(read, on_error, _716_)
  end
  ...
  local function resolve(identifier, _717_0, scope)
    local _718_ = _717_0
    local env = _718_
    local ___replLocals___ = _718_["___replLocals___"]
    local e = nil
    local function _719_(_241, _242)
      return (___replLocals___[scope.unmanglings[_242]] or env[_242])
    end
    e = setmetatable({}, {__index = _719_})
    local function _720_(...)
      local _721_0, _722_0 = ...
      if ((_721_0 == true) and (nil ~= _722_0)) then
        local code = _722_0
        local function _723_(...)
          local _724_0, _725_0 = ...
          if ((_724_0 == true) and (nil ~= _725_0)) then
            local val = _725_0
            return val
          else
            local _ = _724_0
        ...
        return _723_(pcall(specials["load-code"](code, e)))
      else
        local _ = _721_0
        return nil
      end
    end
    return _720_(pcall(compiler["compile-string"], tostring(identifier), {scope = scope}))
  end
  commands.find = function(env, read, on_values, on_error, scope)
    local function _728_(_241)
      local _729_0 = nil
      do
        local _730_0 = utils["sym?"](_241)
        if (nil ~= _730_0) then
          local _731_0 = resolve(_730_0, env, scope)
          if (nil ~= _731_0) then
            _729_0 = debug.getinfo(_731_0)
          else
            _729_0 = _731_0
          end
        else
      ...
      if ((_G.type(_729_0) == "table") and (nil ~= _729_0.linedefined) and (nil ~= _729_0.short_src) and (nil ~= _729_0.source) and (_729_0.what == "Lua")) then
        local line = _729_0.linedefined
        local src = _729_0.short_src
        local source = _729_0.source
        local fnlsrc = nil
        do
          local _734_0 = compiler.sourcemap
          if (nil ~= _734_0) then
            _734_0 = _734_0[source]
          end
          if (nil ~= _734_0) then
            _734_0 = _734_0[line]
          end
    ...
    return run_command(read, on_error, _728_)
  end
  ...
  commands.doc = function(env, read, on_values, on_error, scope)
    ...
    return run_command(read, on_error, _739_)
  end
  ...
  commands.compile = function(_, read, on_values, on_error, _0, _1, opts)
    local function _742_(_241)
      local _743_0, _744_0 = pcall(compiler.compile, _241, opts)
      if ((_743_0 == true) and (nil ~= _744_0)) then
        local result = _744_0
        return on_values({result})
      elseif (true and (nil ~= _744_0)) then
        local _2 = _743_0
        local msg = _744_0
        return on_error("Repl", ("Error compiling expression: " .. msg))
      end
    end
    return run_command(read, on_error, _742_)
  end
  ...
  local function load_plugin_commands(plugins)
    for i = #(plugins or {}), 1, -1 do
      for name, f in pairs(plugins[i]) do
        local _746_0 = name:match("^repl%-command%-(.*)")
        if (nil ~= _746_0) then
          local cmd_name = _746_0
          commands[cmd_name] = f
        end
      end
    end
  ...
  local function run_command_loop(input, read, loop, env, on_values, on_error, scope, chars, opts)
    ...
    do
      local _748_0 = commands[command_name]
      if (nil ~= _748_0) then
        local command = _748_0
  ...
  local function repl(_3foptions)
    ...
    local _757_ = utils.copy(_3foptions)
    local opts = _757_
    local _3ffennelrc = _757_["fennelrc"]
    local _ = nil
    opts.fennelrc = nil
    _ = nil
    ...
    byte_stream, clear_stream = parser.granulate(_759_)
    local chars = {}
    local read, reset = nil, nil
    local function _760_(parser_state)
    ...
    read, reset = parser.parser(_760_)
    depth = (depth + 1)
    ...
    if opts.registerCompleter then
      local function _766_()
        local _765_0 = opts.scope
        local function _767_(...)
          return completer(env, _765_0, ...)
        end
        return _767_
      end
      opts.registerCompleter(_766_())
    end
    ...
    local function loop(exit_next_3f)
      ...
      elseif command_3f(src_string) then
        ...
        if not_eof_3f then
            ...
            if ((_772_0 == true) and (nil ~= _773_0)) then
              ...
              local function _774_(...)
                ...
                if ((_775_0 == true) and (nil ~= _776_0)) then
                  ...
                  return xpcall(_777_, _778_)
                elseif ((_775_0 == false) and (nil ~= _776_0)) then
                  local msg = _776_0
                  clear_stream()
              ...
              return _774_(_781_(...))
            elseif ((_772_0 == false) and (nil ~= _773_0)) then
              local msg = _773_0
              clear_stream()
              return callbacks.onError("Compile", msg)
            end
          ...
          _771_(pcall(compiler.compile, form, _783_()))
  ...
  local function _789_(overrides, _3fopts)
    return repl(utils.copy(_3fopts, utils.copy(overrides)))
  end
  return setmetatable({}, {__call = _789_, __index = {repl = repl}})
end
package.preload["fennel.specials"] = package.preload["fennel.specials"] or function(...)
  ...
  local function wrap_env(env)
    ...
    local function _438_(_, key, value)
      if utils["string?"](key) then
    ...
    local function _440_()
      ...
      do
        ...
        for k, v in utils.stablepairs(env) do
          ...
          if utils["string?"](k) then
            _442_ = compiler["global-unmangling"](k)
          else
            _442_ = k
          end
          k_15_, v_16_ = _442_, v
      ...
      return next, _441_, nil
    end
    return setmetatable({}, {__index = _436_, __newindex = _438_, __pairs = _440_})
  end
  ...
  local function load_code(code, _3fenv, _3ffilename)
    ...
    local _450_0, _451_0 = rawget(_G, "setfenv"), rawget(_G, "loadstring")
    if ((nil ~= _450_0) and (nil ~= _451_0)) then
      local setfenv = _450_0
      local loadstring = _451_0
  ...
  local function doc_2a(tgt, name)
    if not tgt then
      ...
      if ((type(tgt) == "function") or ((type(mt) == "table") and (type(mt.__call) == "function"))) then
        local elts = nil
        do
          local _453_0 = ((compiler.metadata):get(tgt, "fnl/arglist") or {"#<unknown-arguments>"})
          table.insert(_453_0, 1, name)
          elts = _453_0
        end
  ...
  local function compile_value(v)
    ...
    local chunk = {}
    local _462_ = compiler.compile1(v, scope, chunk, opts)
    local _463_ = _462_[1]
    local v0 = _463_[1]
    return v0
  end
  ...
  local function get_fn_name(ast, scope, f_scope, fn_name, multi, _468_0)
    local _469_ = _468_0
    local nval = _469_["nval"]
    local tail = _469_["tail"]
    if (fn_name and (fn_name[1] ~= "nil")) then
      ...
      if not multi then
        ...
        _470_ = compiler["declare-local"](fn_name, {}, _471_, ast)
      else
        _470_ = compiler["symbol-to-expression"](fn_name, scope)[1]
      end
      return _470_, not multi, 3
    else
      return nil, true, 2
    end
  end
  local function compile_named_fn(ast, f_scope, f_chunk, parent, index, fn_name, local_3f, arg_name_list, f_metadata)
    ...
    local _475_
    if local_3f then
      _475_ = "local function %s(%s)"
    else
      _475_ = "%s = function(%s)"
    end
    compiler.emit(parent, string.format(_475_, fn_name, table.concat(arg_name_list, ", ")), ast)
  ...
  local function get_function_metadata(ast, arg_list, index)
    ...
    return maybe_metadata(ast, utils["kv-table?"], _478_, maybe_metadata(ast, utils["string?"], _480_, {["fnl/arglist"] = arg_list}, index))
  end
  SPECIALS.fn = function(ast, scope, parent, opts)
    local f_scope = nil
    do
      local _481_0 = compiler["make-scope"](scope)
      _481_0["vararg"] = false
      f_scope = _481_0
    end
    local f_chunk = {}
  ...
  SPECIALS.lua = function(ast, _, parent)
    ...
    local _487_
    do
      local _486_0 = utils["sym?"](ast[2])
      if (nil ~= _486_0) then
        _487_ = tostring(_486_0)
      else
        _487_ = _486_0
      end
    end
    ...
    local _491_
    do
      local _490_0 = utils["sym?"](ast[3])
      if (nil ~= _490_0) then
        _491_ = tostring(_490_0)
      else
        _491_ = _490_0
      end
    end
  ...
  local function dot(ast, scope, parent)
    ...
    local _494_ = compiler.compile1(lhs_node, scope, parent, {nval = 1})
    local lhs = _494_[1]
    if (len == 2) then
      return tostring(lhs)
    else
      ...
      for i = 3, len do
        ...
        if (utils["string?"](index) and utils["valid-lua-identifier?"](index)) then
          ...
          local _495_ = compiler.compile1(index, scope, parent, {nval = 1})
          local index0 = _495_[1]
  ...
  SPECIALS.let = function(_502_0, scope, parent, opts)
    local _503_ = _502_0
    local _ = _503_[1]
    local bindings = _503_[2]
    local ast = _503_
  ...
  local function disambiguate_3f(rootstr, parent)
    local function _507_()
      local _506_0 = get_prev_line(parent)
      if (nil ~= _506_0) then
        local prev_line = _506_0
        return prev_line:match("%)$")
      end
    end
    return (rootstr:match("^{") or rootstr:match("^%(") or _507_())
  end
  SPECIALS.tset = function(ast, scope, parent)
    ...
    local fmtstr = nil
    if disambiguate_3f(root, parent) then
      fmtstr = "do end (%s)[%s] = %s"
    else
      fmtstr = "%s[%s] = %s"
    end
    return compiler.emit(parent, fmtstr:format(root, table.concat(keys, "]["), value), ast)
  end
  ...
  local function short_circuit_safe_3f(x, scope)
    ...
    elseif utils["list?"](x) then
      if utils["sym?"](x[1]) then
        local _548_0 = str1(x)
        if ((_548_0 == "fn") or (_548_0 == "hashfn") or (_548_0 == "let") or (_548_0 == "local") or (_548_0 == "var") or (_548_0 == "set") or (_548_0 == "tset") or (_548_0 == "if") or (_548_0 == "each") or (_548_0 == "for") or (_548_0 == "while") or (_548_0 == "do") or (_548_0 == "lua") or (_548_0 == "global")) then
          return false
        else
  ...
  local function emit_short_circuit_if(ast, scope, parent, name, subast, accumulator, expr_string, setter)
    ...
    compiler.emit(parent, ("if %s then"):format(_558_()), subast)
    do
      local chunk = {}
  ...
  local function define_arithmetic_special(name, zero_arity, unary_prefix, _3flua_name)
    local _563_
    do
      local _562_0 = (_3flua_name or name)
      local function _564_(...)
        return operator_special(_562_0, zero_arity, unary_prefix, ...)
      end
      _563_ = _564_
    end
    SPECIALS[name] = _563_
  ...
  local function bitop_special(native_name, lib_name, zero_arity, unary_prefix, ast, scope, parent)
    if (#ast == 1) then
      ...
      for i = 2, len do
        ...
        subexprs = compiler.compile1(ast[i], scope, parent, {nval = _565_})
  ...
  SPECIALS.bnot = function(ast, scope, parent)
    compiler.assert((#ast == 2), "expected one argument", ast)
    local _573_ = compiler.compile1(ast[2], scope, parent, {nval = 1})
    local value = _573_[1]
    if utils.root.options.useBitLib then
  ...
  local function native_comparator(op, _575_0, scope, parent)
    local _576_ = _575_0
    local _ = _576_[1]
    local lhs_ast = _576_[2]
    local rhs_ast = _576_[3]
    local _577_ = compiler.compile1(lhs_ast, scope, parent, {nval = 1})
    local lhs = _577_[1]
    local _578_ = compiler.compile1(rhs_ast, scope, parent, {nval = 1})
    local rhs = _578_[1]
  ...
  local function make_compiler_env(ast, scope, parent, _3fopts)
    local provided = nil
    do
      local _589_0 = (_3fopts or utils.root.options)
      if ((_G.type(_589_0) == "table") and (_589_0["compiler-env"] == "strict")) then
        provided = safe_compiler_env()
      elseif ((_G.type(_589_0) == "table") and (nil ~= _589_0.compilerEnv)) then
        local compilerEnv = _589_0.compilerEnv
        provided = compilerEnv
      elseif ((_G.type(_589_0) == "table") and (nil ~= _589_0["compiler-env"])) then
        local compiler_env = _589_0["compiler-env"]
    ...
    local function _592_(symbol)
      compiler.assert(compiler.scopes.macro, "must call from macro", ast)
      return compiler.scopes.macro.manglings[tostring(symbol)]
    end
    local function _593_(base)
      return utils.sym(compiler.gensym((compiler.scopes.macro or scope), base))
    end
    local function _594_(form)
      compiler.assert(compiler.scopes.macro, "must call from macro", ast)
      return compiler.macroexpand(form, compiler.scopes.macro)
    end
    env = {["assert-compile"] = compiler.assert, ["ast-source"] = utils["ast-source"], ["comment?"] = utils["comment?"], ["fennel-module-name"] = fennel_module_name, ["get-scope"] = _591_, ["in-scope?"] = _592_, ["list?"] = utils["list?"], ["macro-loaded"] = macro_loaded, ["multi-sym?"] = utils["multi-sym?"], ["sequence?"] = utils["sequence?"], ["sym?"] = utils["sym?"], ["table?"] = utils["table?"], ["varg?"] = utils["varg?"], _AST = ast, _CHUNK = parent, _IS_COMPILER = true, _SCOPE = scope, _SPECIALS = compiler.scopes.global.specials, _VARARG = utils.varg(), comment = utils.comment, gensym = _593_, list = utils.list, macroexpand = _594_, sequence = utils.sequence, sym = utils.sym, unpack = unpack, version = utils.version, view = view}
    env._G = env
  ...
  local _597_ = _595_(...)
  local dirsep = _597_[1]
  local pathsep = _597_[2]
  local pathmark = _597_[3]
  ...
  local function search_module(modulename, _3fpathstring)
    ...
    local function try_path(path)
      ...
      local _598_0 = (io.open(filename) or io.open(filename2))
      if (nil ~= _598_0) then
        local file = _598_0
        file:close()
        return filename
    ...
    local function find_in_path(start, _3ftried_paths)
      local _600_0 = fullpath:match(pattern, start)
      if (nil ~= _600_0) then
        local path = _600_0
        local _601_0, _602_0 = try_path(path)
        if (nil ~= _601_0) then
          local filename = _601_0
          return filename
        elseif ((_601_0 == nil) and (nil ~= _602_0)) then
          local error = _602_0
          local function _604_()
            local _603_0 = (_3ftried_paths or {})
            table.insert(_603_0, error)
            return _603_0
          end
          return find_in_path((start + #path + 1), _604_())
        end
      else
        local _ = _600_0
  ...
  local function make_searcher(_3foptions)
    local function _609_(module_name)
      local opts = utils.copy(utils.root.options)
      for k, v in pairs((_3foptions or {})) do
        opts[k] = v
      end
      opts["module-name"] = module_name
      local _610_0, _611_0 = search_module(module_name)
      if (nil ~= _610_0) then
        local filename = _610_0
        local function _612_(...)
          return utils["fennel-module"].dofile(filename, opts, ...)
        end
        return _612_, filename
      elseif ((_610_0 == nil) and (nil ~= _611_0)) then
        local error = _611_0
        return error
      end
    end
  ...
  local function fennel_macro_searcher(module_name)
    local opts = nil
    do
      local _614_0 = utils.copy(utils.root.options)
      _614_0["module-name"] = module_name
      _614_0["env"] = "_COMPILER"
      _614_0["requireAsInclude"] = false
      _614_0["allowedGlobals"] = nil
      opts = _614_0
    end
    local _615_0 = search_module(module_name, utils["fennel-module"]["macro-path"])
    if (nil ~= _615_0) then
      local filename = _615_0
      local _616_
  ...
  local function lua_macro_searcher(module_name)
    local _621_0 = search_module(module_name, package.path)
    if (nil ~= _621_0) then
      local filename = _621_0
      local code = nil
      do
        ...
        code = close_handlers_10_(_G.xpcall(_623_, (package.loaded.fennel or debug).traceback))
      end
  ...
  local function search_macro_module(modname, n)
    local _625_0 = macro_searchers[n]
    if (nil ~= _625_0) then
      local f = _625_0
      local _626_0, _627_0 = f(modname)
      if ((nil ~= _626_0) and true) then
        local loader = _626_0
        local _3ffilename = _627_0
  ...
  local function sandbox_fennel_module(modname)
    if ((modname == "fennel.macros") or (package and package.loaded and ("table" == type(package.loaded[modname])) and (package.loaded[modname].metadata == compiler.metadata))) then
      local function _630_(_, ...)
        return (compiler.metadata):setall(...)
      end
      return {metadata = {setall = _630_}, view = view}
    end
  end
  local function _632_(modname)
    ...
    return (macro_loaded[modname] or sandbox_fennel_module(modname) or _633_())
  end
  safe_require = _632_
  ...
  local function resolve_module_name(_634_0, _scope, _parent, opts)
    local _635_ = _634_0
    local second = _635_[2]
    local filename = _635_["filename"]
  ...
  local function include_path(ast, opts, path, mod, fennel_3f)
    ...
    do
      ...
      src = close_handlers_10_(_G.xpcall(_641_, (package.loaded.fennel or debug).traceback))
    end
  ...
  SPECIALS.include = function(ast, scope, parent, opts)
    ...
    local modexpr = nil
    do
      local _644_0, _645_0 = pcall(resolve_module_name, ast, scope, parent, opts)
      if ((_644_0 == true) and (nil ~= _645_0)) then
        local modname = _645_0
    ...
    if ((modexpr.type ~= "literal") or ((modexpr[1]):byte() ~= 34)) then
      ...
      local function _649_()
        local _648_0 = search_module(mod)
        if (nil ~= _648_0) then
          local fennel_path = _648_0
      ...
      res = ((utils["member?"](mod, (utils.root.options.skipInclude or {})) and opts.fallback(modexpr, true)) or include_circular_fallback(mod, modexpr, opts.fallback, ast) or utils.root.scope.includes[mod] or _649_())
...
package.preload["fennel.compiler"] = package.preload["fennel.compiler"] or function(...)
  ...
  local function assert_compile(condition, msg, ast, _3ffallback_ast)
    if not condition then
      local _265_ = (utils.root.options or {})
      local error_pinpoint = _265_["error-pinpoint"]
      local source = _265_["source"]
      local unfriendly = _265_["unfriendly"]
      local ast0 = nil
  ...
  local function serialize_string(str)
    ...
    return string.gsub(string.gsub(string.format("%q", str), ".", serialize_subst), "[\128-\255]", _270_)
  end
  local function global_mangling(str)
    if utils["valid-lua-identifier?"](str) then
      ...
      return ("__fnl_global__" .. str:gsub("[^%w]", _271_))
    end
  end
  local function global_unmangling(identifier)
    local _273_0 = string.match(identifier, "^__fnl_global__(.*)$")
    if (nil ~= _273_0) then
      local rest = _273_0
      local _274_0 = nil
      ...
      _274_0 = string.gsub(rest, "_[%da-f][%da-f]", _275_)
      return _274_0
    else
      local _ = _273_0
      return identifier
  ...
  local function local_mangling(str, scope, ast, _3ftemp_manglings)
    ...
    mangling = string.gsub(string.gsub(raw, "-", "_"), "[^%w_]", _279_)
  ...
  local function flatten_chunk(file_sourcemap, chunk, tab, depth)
    if chunk.leaf then
      local _299_ = utils["ast-source"](chunk.ast)
      local filename = _299_["filename"]
      local line = _299_["line"]
      ...
      do
        ...
        if (_300_0 == true) then
          tab0 = "  "
        elseif (_300_0 == false) then
          tab0 = ""
        elseif (nil ~= _300_0) then
          local tab1 = _300_0
          tab0 = tab1
        elseif (_300_0 == nil) then
          tab0 = ""
        else
        tab0 = nil
        end
  ...
  local function handle_compile_opts(exprs, parent, opts, ast)
    ...
    if opts.target then
      ...
      emit(parent, string.format("%s = %s", opts.target, _324_()), ast)
    end
  ...
  local function find_macro(ast, scope)
    local macro_2a = nil
    do
      local _327_0 = utils["sym?"](ast[1])
      if (_327_0 ~= nil) then
        local _328_0 = tostring(_327_0)
        if (_328_0 ~= nil) then
          macro_2a = scope.macros[_328_0]
        else
          macro_2a = _328_0
        end
      else
  ...
  local function propagate_trace_info(_332_0, _index, node)
    local _333_ = _332_0
    local byteend = _333_["byteend"]
    local bytestart = _333_["bytestart"]
    local filename = _333_["filename"]
    local line = _333_["line"]
    do
  ...
  local function macroexpand_2a(ast, scope, _3fonce)
    ...
    if utils["list?"](ast) then
      _339_0 = find_macro(ast, scope)
    else
    _339_0 = nil
    end
    if (_339_0 == false) then
      return ast
    elseif (nil ~= _339_0) then
      local macro_2a = _339_0
      ...
      utils["walk-tree"](transformed, comp(_343_, quote_literal_nils))
  ...
  local function callable_3f(_349_0, ctype, callee)
    local _350_ = _349_0
    local call_ast = _350_[1]
  ...
  local function compile_function_call(ast, scope, parent, opts, compile1, len)
    local _352_ = compile1(ast[1], scope, parent, {nval = 1})[1]
    local callee = _352_[1]
    local ctype = _352_["type"]
    local fargs = {}
    ...
    for i = 2, len do
      ...
      subexprs = compile1(ast[i], scope, parent, {nval = _353_})
  ...
  local function compile_varg(ast, scope, parent, opts)
    ...
    if scope.hashfn then
      ...
      _358_ = "unexpected vararg"
    end
    assert_compile(scope.vararg, _358_, ast)
  ...
  local function serialize_number(n)
    local _361_0 = string.gsub(tostring(n), ",", ".")
    return _361_0
  end
  local function compile_scalar(ast, _scope, parent, opts)
    local serialize = nil
    do
      local _362_0 = type(ast)
      if (_362_0 == "nil") then
        serialize = tostring
      elseif (_362_0 == "boolean") then
        serialize = tostring
      elseif (_362_0 == "string") then
        serialize = serialize_string
      elseif (_362_0 == "number") then
  ...
  local function compile_table(ast, scope, parent, opts, compile1)
    local function escape_key(k)
      if ((type(k) == "string") and utils["valid-lua-identifier?"](k)) then
        ...
        local _364_ = compile1(k, scope, parent, {nval = 1})
        local compiled = _364_[1]
    ...
    do
      ...
      for k in utils.stablepairs(ast) do
        local val_19_ = nil
        if not keys[k] then
          local _367_ = compile1(ast[k], scope, parent, {nval = 1})
          local v = _367_[1]
  ...
  local function destructure(to, from, ast, scope, parent, opts)
    local opts0 = (opts or {})
    local _371_ = opts0
    local declaration = _371_["declaration"]
    local forceglobal = _371_["forceglobal"]
    local forceset = _371_["forceset"]
    local isvar = _371_["isvar"]
    local symtype = _371_["symtype"]
    ...
    local function destructure_kv_rest(s, v, left, excluded_keys, destructure1)
      ...
      exclude_str = table.concat(_385_, ", ")
    ...
    local function destructure_table(left, rightexprs, top_3f, destructure1)
      ...
      do
        local _387_0 = nil
        if top_3f then
          _387_0 = exprs1(compile1(from, scope, parent))
        else
          _387_0 = exprs1(rightexprs)
        end
        if (_387_0 == "") then
          right = "nil"
        elseif (nil ~= _387_0) then
          local right0 = _387_0
          right = right0
        else
        right = nil
    ...
    local function dynamic_set_target(_396_0)
      local _397_ = _396_0
      local _ = _397_[1]
      local target = _397_[2]
      local keys = {(table.unpack or unpack)(_397_, 3)}
  ...
  local function compile_asts(asts, options)
    ...
    local _407_ = utils.root
    _407_["set-reset"](_407_)
  ...
  local function compile(from, _3fopts)
    local _410_0 = type(from)
    if (_410_0 == "userdata") then
      local function _411_()
        local _412_0 = from:read(1)
        if (nil ~= _412_0) then
          return _412_0:byte()
        else
          return _412_0
      ...
      return compile_stream(_411_, _3fopts)
    elseif (_410_0 == "function") then
  ...
  local function traceback_frame(info)
    ...
    elseif (info.what == "C") then
      ...
      if (info.what == "Lua") then
        ...
        return string.format("\t%s:%d: in function %s", info.short_src, info.currentline, _417_())
  ...
  local function traceback(_3fmsg, _3fstart)
    ...
    if ((msg:find("^%g+:%d+:%d+ Compile error:.*") or msg:find("^%g+:%d+:%d+ Parse error:.*")) and not utils["debug-on?"]("trace")) then
      ...
      while not done_3f do
        do
          local _421_0 = debug.getinfo(level, "Sln")
          if (_421_0 == nil) then
            done_3f = true
  ...
  local function do_quote(form, scope, parent, runtime_3f)
    ...
    elseif utils["sequence?"](form) then
      ...
      return string.format("setmetatable({%s}, {filename=%s, line=%s, sequence=%s})", mixed_concat(mapped, ", "), filename, _431_, "(getmetatable(sequence()))['sequence']")
    elseif (type(form) == "table") then
      ...
      return string.format("setmetatable({%s}, {filename=%s, line=%s})", mixed_concat(mapped, ", "), filename, _434_())
...
package.preload["fennel.friend"] = package.preload["fennel.friend"] or function(...)
  ...
  local function highlight_line(codeline, col, _3fendcol, opts)
    if ((opts and (false == opts["error-pinpoint"])) or (os and os.getenv and os.getenv("NO_COLOR"))) then
      ...
      local _185_ = (error_pinpoint or {"[7m", "[0m"})
      local open = _185_[1]
      local close = _185_[2]
  ...
  local function parser_fn(getbyte, filename, _204_0)
    ...
    local function parse_stream()
      ...
      local function dispatch(v, _3fsource, _3fraw)
        ...
        local v0 = nil
        do
          local _217_0 = (_3fsource and ("table" ~= type(v)) and utils["hook-opts"]("parse-literal", options, v, _3fsource, _3fraw))
          if (nil ~= _217_0) then
            local hookv = _217_0
            v0 = hookv
          else
      ...
      local function parse_string(source0)
        ...
        local _247_0 = (rawget(_G, "loadstring") or load)(("return " .. formatted))
        if (nil ~= _247_0) then
          local load_fn = _247_0
          return dispatch(load_fn(), source0, raw)
        elseif (_247_0 == nil) then
      ...
      local function parse_number(rawstr, source0)
        ...
        if rawstr:match("^%d") then
          ...
          local _253_0 = tonumber(number_with_stripped_underscores)
          if (nil ~= _253_0) then
            local x = _253_0
...
local function eval(str, _3foptions, ...)
  ...
  loader = specials["load-code"](lua_source, env, _795_(...))
  opts.filename = nil
  return loader(...)
end
...
local function syntax()
  ...
  for k, v in pairs(_G) do
    local _796_0 = type(v)
    if (_796_0 == "function") then
      out[k] = {["function?"] = true, ["global?"] = true}
    elseif (_796_0 == "table") then
...
do
  ...
  package.preload[module_name] = _800_
  _ = nil
  local env = nil
  do
    local _801_0 = specials["make-compiler-env"](nil, compiler.scopes.compiler, {})
    _801_0["utils"] = utils
    _801_0["fennel"] = mod
    _801_0["get-function-metadata"] = specials["get-function-metadata"]
    env = _801_0
  end
